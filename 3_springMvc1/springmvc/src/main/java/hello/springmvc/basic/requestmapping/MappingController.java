...
public class MappingController {
    ...
    public String mappingPath(@PathVariable("userId") String userId) { // @PathVariable("userId") String data
     ...
     */
    @PostMapping(value = "/mapping-consume", consumes = MediaType.APPLICATION_JSON_VALUE) // produces = "applicaiont/json"
